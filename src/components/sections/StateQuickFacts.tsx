...
import type { StateQuickFact } from "@/lib/states";
...
interface StateQuickFactsProps {
  stateName: string;
  items: StateQuickFact[];
}

export function StateQuickFacts({ stateName, items }: StateQuickFactsProps) {
    ...
    <section className="bg-gray-50 py-20 md:py-24">
      <div ref={ref} className="mx-auto max-w-7xl px-6 md:px-10 lg:px-16">
        ...
        <div className="mt-12 flex flex-col gap-12 lg:flex-row lg:items-stretch lg:gap-20">
          ...
          >
            <div className="flex h-72 w-full items-center justify-center rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 ring-1 ring-gray-200/60 lg:h-full">
