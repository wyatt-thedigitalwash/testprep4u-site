...
const icons = [Monitor, MapPin, GraduationCap, BrainCircuit, Users, Target];

export function FeatureGrid() {
  const { headline, subheadline, cards } = homePage.featureGrid;
          ...
          {cards.map((card, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Description */}
                <p className="mt-2 min-h-[3rem] text-sm leading-relaxed text-gray-500">
                  {card.description}
                </p>
